...
function iscrtajRaspored(div, dani, satPocetak, satKraj) {
  ...
  if (satPocetak >= satKraj || satPocetak < 0 || satPocetak >= 24 ||
    satKraj < 0 || satKraj > 24 || satPocetak % 1 !== 0 || satPocetak % 1 !== 0) {
    let error = "Greška";
    div.innerHTML = error;
    return;
  }
...
function dodajAktivnost(raspored, naziv, tip, vrijemePocetak, vrijemeKraj, dan) {
  ...
  //Provjeravamo da li je raspored kreiran
  ...
  //Definišemo uslove tipa da vrijemePocetak mora biti manje od vrijemeKraj, brojevi cijeli ili sa 0.5 decimalnom vrijednošću i sl
